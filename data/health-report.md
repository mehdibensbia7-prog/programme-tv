...
Généré le 2 août 2026 à 16:29

8 OK · 4 avertissement(s) · 0 échec(s) · 0 auto-réparation(s)

## Détail

- ⚠️ **data/news-ai.json** — Donnée périmée : dernière mise à jour il y a 8.6h (seuil : 8h).
- ⚠️ **data/trends-ai.json** — Donnée périmée : dernière mise à jour il y a 8.6h (seuil : 8h).
- ✅ **data/videos.json** — 5 élément(s), mis à jour il y a 0.7h.
- ⚠️ **data/films-releases.json** — Donnée périmée : dernière mise à jour il y a 8.6h (seuil : 8h).
- ⚠️ **data/series-releases.json** — Donnée périmée : dernière mise à jour il y a 8.6h (seuil : 8h).
